        ...
        <div class="contents">
            ...
            <ul class="view">
                ...
                <li class="boardPrev">
					...
					<% if prev_idx="" then %>
						<a style="color:silver; text-decoration:none">There's no previous article.</a>
					<% else %>
                ...
                <li class="boardNext">
					...
					<% if next_idx="" then %>
						<a style="color:silver; text-decoration:none">There is no next article.</a>
					<% else %>
            ...
            <a href="4.asp<%= p_cmd %><%= s_cmd %>" class="solidBtn">List</a>
        </div>
    </div>
</div>
<div id="footer"></div>
