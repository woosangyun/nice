        ...
        <div class="contents">
                	...
                	<div class="stock1">
                        ...
                        <div class="stockUpDown">
                            <ul class="stockList">
                                <li class="yesterday">
                                    <ul>
                                        <li class="key" style="width:55px">(+/-)</li>
                ...
                <div class="stockRight">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="noMG">
                        ...
                        <!--
                            ...
                            <tr>
                                <th class="left">No. of Listed Shares (shr)</th>
                                <td><%= Amount %></td>
                            </tr>
                            <tr>
                                <th class="left">Market Cap(KRW in millions)</th>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tbody>
                    ...
                    <tr>
                        <th class="left">Last Price(KRW)</th>
                        <td><%= PrevJuka %></td>
                        <th class="left">Ask</th>
                        <td class="extra_field"><%= extra_medoHoka %></td>
                    </tr>
                    <tr>
                        <th class="left">Last Trading Volume(shares)</th>
                        <td><span id="extra_PrevValue" class="extra_field"></span></td>
                        <th class="left">Bid</th>
                        <td class="extra_field"><%= extra_mesuHoka %></td>
                    </tr>
                    <tr>
                        <th class="left">Upper limit price(KRW)</th>
                        <td><%= UpJuka %></td>
                        <th class="left">High in a year(KRW)</th>
                        <td><%= High52 %></td>
                    </tr>
                    <tr>
                        <th class="left">Lower limit price(KRW)</th>
                        <td><%= DownJuka %></td>
                        <th class="left">Low in a year(KRW)</th>
                        <td><%= Low52 %></td>
                    </tr>
                    <tr>                              
                        <th class="left">Par Value(KRW)</th>
                        <td><%= FaceJuka %></td>
            ...
            <div class="result table_inner scroll">
                ...
                <tbody>
					...
					<tr>
                        ...
                        <!--<td class="center"><span class="extra_field"><%= time_totalprice %></span></td> 181005-->
                    </tr>
					<%
								next
