	...
	if cd="edit" then
		...
		set rs=cmd.execute
			if rs.eof or rs.bof then
				...
				a_title=replace(a_title,chr(34),"&quot;")
			end if
		set rs=nothing
	end if
%>
...
<% call html_top() %>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td><img src="img/m_title_agreement.gif" width="595" height="54"></td>
                                      </tr>
                                      <tr>
                                        <td height="16">&nbsp;</td>
                                      </tr>
...
<!--ir자료_write 테이블 시작 ################################################-->
	...
	<script language="javascript">
		function sendit(on) {
			...
			on.a_content.value=content_field_editor.getHtml();
		...
		<td> 
			...
			<tr> 
				...
				<td width="504" height="27" class="space"> 
					<input type="text" id="a_title" name="a_title" value="<%= a_title %>" size="50" maxlength="50" class="inputbox">
				</td>
			</tr>
			<tr> 
			...
			<tr> 
				...
				<td class="space"> 
					<textarea id="a_content" name="a_content" style="width:498px; height:200px"><%= a_content %></textarea>
				</td>
			</tr>
			<tr> 
				<td bgcolor=#dcdcdc colspan=2 height=1></td>
...
<!--ir자료_write 테이블 끝 ##################################################-->
			...
			<script language="javascript">
				var content_field_editor=new easyEditor("a_content","admin",475,300);
